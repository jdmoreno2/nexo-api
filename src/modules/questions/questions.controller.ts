...
import { ResponseQuestionsDto } from './dto/response/response-questions.dto';
...
export class QuestionsController {
  ...
  @ApiOkResponse({ description: 'Lista paginada de Preguntas', type: PaginationDto<ResponseQuestionsDto> })
  ...
  @ApiOkResponse({ description: 'Pregunta obtenida exitosamente', type: ResponseQuestionsDto })
